...
const InputMessage = () => {
  ...
  return (
    <div 
      className="mx-[5px] mb-[5px] py-2 px-2 sticky bottom-0 flex items-end gap-3
      ...
      <input
        ...
        type="text" 
        placeholder="Type..." 
        className="w-full h-fit py-2 px-2 text-wrap overflow-y-auto
      ...
      />
      <div className="relative h-fit min-w-fit group">
        <div
      ...
      <div
        ...
        className="py-2 px-2 min-w-9 items-center justify-center bg-light-bg text-dark-text dark:bg-dark-bg dark:text-light-text
        shadow-custom-light dark:shadow-custom-dark
        active:shadow-custom-light-inset dark:active:shadow-custom-dark-inset 
        rounded-md cursor-pointer relative overflow-hidden">
        
        <IoSend className="min-w-5 min-h-5 text-center text-dark-text dark:text-light-text relative z-10"/>
